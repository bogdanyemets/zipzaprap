...
type
  TfrmMenu = class(TForm)
    ...
    procedure ImageBlackClick(Sender: TObject);
  private
...
image8.Top:=frmMenu.Top+2;
image8.Left:=frmMenu.Left+frmMenu.Width-105;
end;

procedure TfrmMenu.Image10Click(Sender: TObject);
begin
winexec('barley-break/Project1.exe',SW_NORMAL);
end;

procedure TfrmMenu.Image10MouseEnter(Sender: TObject);
begin
image10.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\1.png');
end;

procedure TfrmMenu.Image10MouseLeave(Sender: TObject);
begin
image10.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\2.png');
end;
...
begin
image11.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\1.png');
end;

procedure TfrmMenu.Image11MouseLeave(Sender: TObject);
begin
image11.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\2.png');
end;
...
begin
image12.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\1.png');
end;

procedure TfrmMenu.Image12MouseLeave(Sender: TObject);
begin
image12.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\2.png');
end;
...
begin
image13.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\1.png');
end;

procedure TfrmMenu.Image13MouseLeave(Sender: TObject);
begin
image13.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\2.png');
end;
...
begin
image2.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\1.png');
end;

procedure TfrmMenu.Image2MouseLeave(Sender: TObject);
begin
image2.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\2.png');
end;
...
begin
image3.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\1.png');
end;

procedure TfrmMenu.Image3MouseLeave(Sender: TObject);
begin
image3.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\2.png');
end;
...
begin
image4.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\1.png');
end;

procedure TfrmMenu.Image4MouseLeave(Sender: TObject);
begin
image4.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\2.png');
end;
...
begin
image5.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\1.png');
end;

procedure TfrmMenu.Image5MouseLeave(Sender: TObject);
begin
image5.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\2.png');
end;
...
begin
image7.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\exit_2.png');
end;

procedure TfrmMenu.Image7MouseLeave(Sender: TObject);
begin
image7.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\exit_1.png');
end;
...
begin
image8.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\minimize_2.png');
end;

procedure TfrmMenu.Image8MouseLeave(Sender: TObject);
begin
image8.Picture.LoadFromFile(extractfilepath(paramstr(0))+'stuff\minimize_1.png');
end;

procedure TfrmMenu.ImageBlackClick(Sender: TObject);
begin
